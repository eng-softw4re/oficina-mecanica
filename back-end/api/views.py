...
from .models import Cliente, Veiculo, Procedimento, OrdemServico, Insumo
from .serializers import ClienteSerializer, VeiculoSerializer, ProcedimentoSerializer, OrdemServicoSerializer, InsumoSerializer
