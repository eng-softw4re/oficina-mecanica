...
SECRET_KEY = "django-insecure-zf48$v5k*lj!*lzvf98j-^j3jy(7)8kj=ode1p^6a@i8yfsj4y"
...
# Permite receber requesições de qualquer origem
...
CORS_ALLOWED_ORIGINS = [
    "http://localhost:5173", # Endereço padrão do React em desenvolvimento
    "http://127.0.0.1:8000",
]
